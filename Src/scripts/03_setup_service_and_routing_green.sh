...
docker service create --name demo_cluster-green --network balancers-network --network internal-network --replicas 3 --env DOCKER_SERVICE_NAME=green -p 3001:3000 marcsolde/demo-app:v2
